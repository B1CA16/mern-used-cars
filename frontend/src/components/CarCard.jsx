  ...
  return (
    <div onClick={handleNavigate} className="dark:bg-neutral-800 rounded-lg overflow-hidden hover:cursor-pointer shadow transform transition-transform duration-300 hover:scale-105">
      ...
      <div className="p-4">
        ...
        <p className="text-neutral-800 dark:text-neutral-400">{car.year} &#x2022; {formatNumber(car.km)} km</p>
        <p className="text-neutral-800 dark:text-neutral-400 truncate">{car.fuel} &#x2022; {car.hp} HP</p>
        <p className="text-blue-700 font-semibold text-xl mt-2">{formatNumber(car.price)} <span className='text-sm'>EUR</span></p>
      </div>
    </div>
  );
}
